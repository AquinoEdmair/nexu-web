...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: t('deposits'),   href: '/deposits',    icon: Wallet },
    { name: t('withdrawals'),href: '/withdrawals', icon: CreditCard },
    { name: t('yields'),     href: '/yields',      icon: TrendingUp },
    { name: t('referrals'),  href: '/referrals',   icon: Users },
